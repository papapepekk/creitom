		...
		try {
          ...
          teks = 'bloqueado com sucesso:\n'
                ...
                case 'lionlogo':
                      ...
                      break
                case 'verdade':
					const truth = [`Você já gostou de alguém? quanto tempo? `,` Se você pode ou se quiser, na gc / fora da gc com quem você vai fazer amizade? (você pode ser diferente / do mesmo sexo) `,`equal é o seu maior medo? `,` Você já gostou de alguém e sentiu que essa pessoa também gostava de você? `,` Qual é o nome do seu  ex-namorado(a) que você gostava secretamente? `,` vocêê já roubou o dinheiro da sua mãe ou do pai? `,` amor nunca correspondido? se alguma vez com quem? como se sente, brou?  `,` as pessoas já foram traídas? `,` a coisa que você mais teme `,` quem é a pessoa que tem mais influência em sua vida `,` Que coisas orgulhosas você teve este ano `,` quem é a pessoa que pode fazer você se sentir desconfortável `,` quem é a pessoa que já fez você se sentir desconfortável `,`  nunca orou o dia todo ? `,` As pessoas já te recusaram? o motivo por quê? `,` Mencione o incidente que te machucou e que você ainda se lembra `,` o que você ganhou este ano?]
					const truth = trut[Math.floor(Math.random() * trut.length)]
					truteh = await getBuffer 284 (https://i.ibb.co/305yt26/bf84f20635dedd5dde31e7e5b6983ae9.jpg`
			  (client.sendMessage(from, trutehimage, { caption: '*Truth*\n\n'+ ttrth, quoted: mek })
					break
				case 'dare':
